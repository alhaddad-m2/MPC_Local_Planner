...
void setting_mpc_conditions()
{
    ...
    mpc.max_length_path = 3.5;
    mpc.stop_solving_length = 1;
    mpc.v_path = 0.2;
    mpc.print_local_path = false;
    mpc.print_initial_guess = true;
...
{
    pub_marker_init_gues    = n.advertise<visualization_msgs::Marker> ("mpc_palnner/mk_initial",    10);
    pub_marker_opt_traj     = n.advertise<visualization_msgs::Marker> ("mpc_palnner/mk_local_path", 10);
    pub_marker_filter_path  = n.advertise<visualization_msgs::Marker> ("mpc_palnner/mk_filter_path",10);
    pub_marker_obst_cells   = n.advertise<visualization_msgs::Marker> ("mpc_palnner/mk_obst_cells", 10);
    ...
    status_control_sub      = n.subscribe(control_status_topic, 10, status_control_back);
}
